...
from .base import Chunk, ChunkerInterface, ChunkType
...
class TextChunker(ChunkerInterface):
    ...
    def _generate_id(content: str, metadata: dict[str, Any], index: int) -> str:
        ...
        return hashlib.md5(hash_input.encode()).hexdigest()  # noqa: S324 - deterministic id, not security
